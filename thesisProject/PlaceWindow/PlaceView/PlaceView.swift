...
class PlaceView: UIScrollView {
    ...
    init(with frame: CGRect, placeCoordinate: CLLocationCoordinate2D, corespondingVC: PlaceViewController, with placeName: String, and placeCity: String, and description: String) {
        ...
        cityLabel.font = UIFont(name: "Helvetica", size: 22)
        ...
        addToFavoritesButton.backgroundColor = #colorLiteral(red: 0.4431372549, green: 0.5647058824, blue: 0.8784313725, alpha: 1)
        addToFavoritesButton.setTitle("Add to favorites", for: .normal)
        addToFavoritesButton.titleLabel?.font = UIFont(name: "Helvetica", size: 16)
    ...
    func changeButtonColorToDark(bool: Bool) {
        if bool == true {
            self.addToFavoritesButton!.backgroundColor = #colorLiteral(red: 0.3385908139, green: 0.5, blue: 0.74464231, alpha: 1)
            self.addToFavoritesButton!.setTitle("Remove from favorites", for: .normal)
        } else {
            self.addToFavoritesButton!.backgroundColor = #colorLiteral(red: 0.4431372549, green: 0.5647058824, blue: 0.8784313725, alpha: 1)
